...
# --- 1. AYARLAR ---
st.set_page_config(page_title="Mutabakat Pro V42", layout="wide")
...
def ozet_rapor_olustur(df_biz_raw, df_onlar_raw):
    ...
    # Fark Hesabı (Biri +, biri - ise topla)
...
def veri_hazirla(df, config, taraf_adi, is_insurance_mode, extra_cols=[]):
    ...
    # Ödeme Ayrıştırma (Sadece Sigortada)
...
with c_title: st.title("🗂️ Mutabakat Pro V42")
with c_settings:
                    ...
                    if is_ins:
                        ...
                        if key in dict_onlar_tutar:
                            ...
                            if best:
                                ...
                                eslesenler.append(make_row("✅ Tam Eşleşen Poliçe", best, 0.0))
                                found = True
                        ...
                        # C/H MODU (BURAYI KISALTTIK - ESKİ HALİ KORUNUR)
                        pass
...
if st.session_state.get('analiz_yapildi', False):
    ...
    else: dfs_exp["Eşleşen Ödemeler"] = res["odeme"]
